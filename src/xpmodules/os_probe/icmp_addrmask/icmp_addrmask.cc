...
int icmp_addrmask_mod_init(Xprobe_Module_Hdlr *pt,const char *nm) {
    ...
    pt->add_keyword(module->get_id(),(string&)"icmp_addrmask_reply");
    pt->add_keyword(module->get_id(),(string&)"icmp_addrmask_reply_ttl");
	pt->add_keyword(module->get_id(),(string&)"icmp_addrmask_reply_ip_id");

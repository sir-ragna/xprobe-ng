/* $Id: cmd_opts.cc,v 1.21 2006/10/07 08:01:11 mederchik Exp $ */
/*
...
int Cmd_Opts::parse(int argc, char *argv[]) {
	int c, modcount = xmh->get_module_count();
	long mod_to_disable, mod_to_enable;
...
long Cmd_Opts::get_numofmatches() {
